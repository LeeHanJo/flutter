          ...
          body: Column(
            children: [
              ...
              Expanded(
                 ...
                 * FutureBuilder는 데이터를 요청할 때 builder 가 동작하고, 데이터를 받아왔을 때, 다시 builder 가 동작하여
                 * 데이터를 받아 온 뒤에 화면이 다시 그려지면서 데이터를 출력해줄수 있다.
                 * */
                ...
                child: FutureBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      /**
                       * snapshot.data는 값을 가지고으넨디 시간이 걸린다.
                       * docs의 경우 데이터가 있는 경우에만 호출이 가능하기 떄문에 data 뒤에 ? nullable 을 지정해준다.
                       * */
